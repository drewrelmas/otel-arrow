...
pub mod auth {
    ...
    /// Shared (Send + Sync) trait variant of the client-credential-provider capability.
    pub mod client_credential_provider {
        pub use crate::capability::auth::client_credential_provider::shared::ClientCredentialProvider;
    }
}
