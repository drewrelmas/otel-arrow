...
pub static OAUTH2_CLIENT_AUTH_EXTENSION: ExtensionFactory = ExtensionFactory {
    ...
    description: "Active+Shared extension exposing bearer and typed client credentials via OAuth 2.0",
    documentation_url: "",
    capabilities: Some(extension_capabilities!(
        shared: OAuth2ClientAuthExtension => [BearerTokenProvider, ClientCredentialProvider]
    )),
    create,
    validate_config,
};
